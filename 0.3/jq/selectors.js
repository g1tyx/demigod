$(document).ready(function(){
    ...
    hammer.click(function(){
        ...
        //undo machen
        if(civ.hammer==1 && civ.hammer2==1 && civ.hammer3==1){player.undo_point=civ.counter;}

        playAudio(2);
        civ.hammer=0;

        civ.counter*=2+solarsystems_num;
    ...
    hammer2.click(function(){
        ...
        civ.counter*=2+solarsystems_num+civ.hammer2_factor;
    ...
    hammer3.click(function(){
        ...
        civ.counter*=2+solarsystems_num+civ.hammer3_factor;
